...
from app.services.notification_providers import AstrBotBridgeNotifier, NotificationProvider
...
class MonitoringService:
    def __init__(self, _legacy_lock: object | None = None, notification_provider: NotificationProvider | None = None) -> None:
        ...
        self._notification_provider = notification_provider or AstrBotBridgeNotifier.from_environment()
